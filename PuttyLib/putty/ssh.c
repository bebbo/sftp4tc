...
#define get_userpass_input(a,b,c) console_get_userpass_input(a,b,c)

#define ssh_share_test_for_upstream(a,b,c) 0
#define ssh_setup_portfwd(a,b)
#define ssh_connection_sharing_init(a,b,c,d,e) 0
#define share_ndownstreams(a) 0
#define sharestate_free(a)
#define share_activate(a,b)
#define share_got_pkt_from_server(a,b,c,d)

#define pfd_connect(a,b,c,d,e,f) NULL
#define pfd_close(a)
#define pfd_confirm(a)
#define pfd_override_throttle(a,b)
#define pfd_unthrottle(a)
#define pfd_init(a,b,c,d) NULL
#define pfd_free_fake_auth(a)
#define pfd_free_display(a)
#define pfd_send_eof(a)
#define pfd_send(a,b,c) 0
#define pfl_terminate(a)


#define x11_close(a)
#define x11_override_throttle(a,b)
#define x11_unthrottle(a)
#define x11_init(a,b,c,d) NULL
#define x11_free_fake_auth(a)
#define x11_free_display(a)
#define x11_send_eof(a)
#define x11_send(a,b,c) 0
#endif
