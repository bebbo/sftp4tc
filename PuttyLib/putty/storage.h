...
void write_setting_filename(struct KeyOrIni*handle, const char *key, Filename *value);
void write_setting_fontspec(struct KeyOrIni*handle, const char *key, FontSpec * font);
...
FontSpec * read_setting_fontspec(struct KeyOrIni *, const char *key);
