...
public:
	...
	inline bstring const & getName() const { return name; }
...
private:
	...
	void insertFile(bstring const & remotePath, FILETIME * ft, unsigned long szLo, unsigned long szHi, char kind, bstring const & chmod = TEXT("---"));
