...
typedef void (__stdcall *tLogProc)(int PluginNr,int MsgType,char const* LogString);
typedef void (__stdcall *tLogProcW)(int PluginNr,int MsgType,WCHAR const* LogString);
